...
CONFIG_LIST=(
    "TAU_CHARGER_CAPACITY=5 ZETA_NUM_WORKERS=5 ETA_WORK_ENERGY_RATE=1 DELTA_COMMUTE=40"
    "TAU_CHARGER_CAPACITY=6 ZETA_NUM_WORKERS=5 ETA_WORK_ENERGY_RATE=1 DELTA_COMMUTE=50"
