...
CONFIG_LIST=(
    "ENERGY_TYPE=supercap TAU_CHARGER_CAPACITY=3 ZETA_NUM_WORKERS=4 ETA_WORK_ENERGY_RATE=8 DELTA_COMMUTE=190"
    "ENERGY_TYPE=supercap TAU_CHARGER_CAPACITY=5 ZETA_NUM_WORKERS=5 ETA_WORK_ENERGY_RATE=1 DELTA_COMMUTE=40"
    "ENERGY_TYPE=battery TAU_CHARGER_CAPACITY=5 ZETA_NUM_WORKERS=5 ETA_WORK_ENERGY_RATE=1 DELTA_COMMUTE=40"
    "ENERGY_TYPE=supercap TAU_CHARGER_CAPACITY=7 ZETA_NUM_WORKERS=3 ETA_WORK_ENERGY_RATE=5 DELTA_COMMUTE=290"
    "ENERGY_TYPE=supercap TAU_CHARGER_CAPACITY=8 ZETA_NUM_WORKERS=2 ETA_WORK_ENERGY_RATE=7 DELTA_COMMUTE=140"
...
for CONFIG in "${CONFIG_LIST[@]}"; do
    ...
    JOBNAME="${ENERGY_TYPE}-tau${TAU_CHARGER_CAPACITY}-w${ZETA_NUM_WORKERS}-eta${ETA_WORK_ENERGY_RATE}-delta${DELTA_COMMUTE}"
    ...
    sed -i "s/ENERGY_TYPE_PLACEHOLDER/$ENERGY_TYPE/g" "$OUTPUT"
    ...
    echo "Submitting run with TYPE=$ENERGY_TYPE, TAU=$TAU_CHARGER_CAPACITY, ZETA=$ZETA_NUM_WORKERS, ETA=$ETA_WORK_ENERGY_RATE, DELTA=$DELTA_COMMUTE"
    sbatch "$OUTPUT"
done
